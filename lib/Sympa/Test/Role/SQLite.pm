package Sympa::Test::Role::SQLite;

=head1 NAME

Sympa::Test::Role::SQLite

=cut

use File::Temp;
use Test::Roo::Role;
with 'Sympa::Test::Role::Database';

=head1 METHODS

See also L<Sympa::Test::Role::Database> which is consumed by this role.
...
sub _build_database_info {
    ...
    return "SQLite library version: "
      . $self->sympa_schema->storage->dbh->{sqlite_version};
}
